...
import { ImageIcon, Tag, FileText, X, Clock, CloudUpload, Smile, Save, Send, Music } from 'lucide-react';
...
interface Props {
  ...
  music?: any; setMusic?: (val: any) => void;
...
export default function MetaMatrix({
  type, tags, setTags, cover, setCover, summary, setSummary, mood, setMood, music, setMusic,
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden relative">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-8 flex flex-col gap-10">
        ...
        {/* 3. 心情区 */}
        {/* Music BGM picker — only for posts */}
        {type === 'post' && setMusic && (
          <div className="mb-8">
            <Label icon={Music} text="BGM 配乐" color="border-purple-500" />
            <MusicSearchInput value={music} onChange={setMusic} />
          </div>
        )}
