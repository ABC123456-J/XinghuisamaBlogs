...
export default function EditorClient({ historyPostTags, historyChatterTags, historyMoods }: any) {
      ...
      const loadDraft = async () => {
        try {
          ...
          const res = await fetch(`http://127.0.0.1:${config.api_port}/api/drafts/get`, {
            ...
            body: JSON.stringify({ blog_path: "D:/123pan/Downloads/untitled/XinghuisamaBlogs/XHBlogs", id: docId })
          });
  ...
  const handleSave = async (isPublish: boolean) => {
    setIsSaving(true);
    const payload = {
      blog_path: "D:/123pan/Downloads/untitled/XinghuisamaBlogs/XHBlogs",
